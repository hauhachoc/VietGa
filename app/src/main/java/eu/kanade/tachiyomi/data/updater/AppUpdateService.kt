...
class AppUpdateService : Service() {
    ...
    override fun onCreate() {
        ...
        startForeground(
            ...
            notifier.onDownloadStarted(getString(R.string.app_name_VietGa)).build(),
        )
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        val title = intent.getStringExtra(EXTRA_DOWNLOAD_TITLE) ?: getString(R.string.app_name_VietGa)
    ...
    companion object {
        ...
        fun start(context: Context, url: String, notifyOnInstall: Boolean) {
            if (!isRunning()) {
                val title = context.getString(R.string.app_name_VietGa)
